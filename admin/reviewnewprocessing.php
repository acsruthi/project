 ...
 <?php 
    ...
    if($_FILES['image']['name']) //if an image has been uploaded 
      { 
         ...
         elseif(($_FILES['image']['type'] == 'image/jpg') || ($_FILES['image']['type'] == 'image/jpeg') || 
         ($_FILES['image']['type'] == 'image/gif') || ($_FILES['image']['type'] == 'image/png') && in_array($extension, $allowedExts))
      ...
      $sql="INSERT INTO review (reviewTitle, reviewContent, reviewDT, adminID, categoryID, reviewRating, reviewImage) 
      VALUES ('$title', '$content', NOW(), '$adminID', '$categoryID', '$rating', '$newImageName')";
     ...
     header("location:reviews.php"); //redirect to index.php
